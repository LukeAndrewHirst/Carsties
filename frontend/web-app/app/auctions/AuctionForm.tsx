        ...
        {pathname === '/auctions/create' &&
          <>
            ...
            <div className='grid grid-cols-2 gap-3'>
              ...
              <DateInput label='Auction End Date' name='auctionEnd' control={control} dateFormat='yyyy-MM-dd h:mm a' showTimeSelect rules={{required: 'Auction End Date is required'}} />
            </div>
          </>
        }
